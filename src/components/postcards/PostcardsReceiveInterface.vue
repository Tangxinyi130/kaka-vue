  ...
  <div style="width:100%;height:590px;background-color:#ebf6df">
    <div class="container" style=" height: 500px;background-color:lightgoldenrodyellow">
      <div class="row" style="height:53px;background-color:#528970">
        <div class="col-sm-12" style="width:200px;height:53px;line-height: 52px;font-size: 18px;color: white">接收明信片</div>
      </div>
          ...
          <form>
            ...
            <div class="col-sm-5 col-sm-offset-5">接收一张明信片</div>
              ...
              <div class="col-sm-5 col-sm-offset-5">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="请输入明信片的ID">
              </div>
              </div>
              <div class="row">
                ...
                <div class="row">
                  <div class="col-sm-10 col-sm-offset-1" style="height:110px;"></div>
                </div>
                <div class="row">

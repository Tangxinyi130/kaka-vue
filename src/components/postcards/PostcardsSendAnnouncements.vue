      ...
      <div class="row con-body">
        <div class="container col-sm-8 col-sm-offset-2">
          <div class="row con-body-row"  v-if="$store.state.postSendAnn">
            ...
            <div class="">
              <p class="tishi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本服务旨在为用户提供本公司商品信息，并接受购买商品的订单。本条约适用于由于本服务而产生的用户和本公司之间的所有事项本公司在未得到用户允许的情况下，对本条约拥有变更的权利。并且本公司将使用合适的方法告知用户用户在遵守本条约前提下，承诺只使用本公司提供的服务。本服务中提供的信息及相关著作权等一些知识产权，属本公司所有。</p>
            </div>
            <div class="col-sm-offset-1 ag">第1条:服务概要/目的</div>
            <div class="col-sm-offset-1 ag">第2条:本条约的使用范围</div>
